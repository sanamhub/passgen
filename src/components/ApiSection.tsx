          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-2">
                This public API allows you to generate secure passwords with
            ...
            <div>
              ...
              <ul className="text-sm space-y-2">
                <li>
                  ...
                  : Password length (number, default: 12)
                </li>
                <li>
                  <code className="bg-muted/50 px-1.5 py-0.5 rounded">
                    characterMode
                  </code>
                  : Character set mode ("all", "easyToSay", or "easyToRead",
                  default: "all")
                </li>
                <li className="ml-4">
                  When{" "}
                ...
                <li className="ml-8">
                  ...
                  : Include uppercase letters (boolean, default: true)
                </li>
                <li className="ml-8">
                  <code className="bg-muted/50 px-1.5 py-0.5 rounded">
                    lowercase
                  </code>
                  : Include lowercase letters (boolean, default: true)
                </li>
                <li className="ml-8">
                  <code className="bg-muted/50 px-1.5 py-0.5 rounded">
                    numbers
                  </code>
                  : Include numbers (boolean, default: true)
                </li>
                <li className="ml-8">
                  <code className="bg-muted/50 px-1.5 py-0.5 rounded">
                    symbols
              ...
              <div className="space-y-3">
                <div>
                  <p className="text-sm mb-1">
                    Default password (no parameters):
                  </p>
                  <div className="relative group">
                    <pre className="line-numbers language-markup rounded-md overflow-x-auto bg-muted/50 p-4">
                      <code className="language-markup whitespace-nowrap">
                        {apiUrl}
                      </code>
                    </pre>
                    <Button
                ...
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        copyToClipboard(
                          `${apiUrl}?${exampleQueryParamsEasyToSay}`,
                          "easyToSay"
                        )
                      }
                    >
                      {copiedItems["easyToSay"] ? (
                        <Check className="h-4 w-4" />
                      ) : (
                        <Copy className="h-4 w-4" />
                      )}
            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="relative group">
                    <pre className="line-numbers language-json rounded-md overflow-x-auto bg-muted/50 p-4">
                      <code className="language-json whitespace-nowrap">
                        {responseExample}
                      </code>
                    </pre>
                    <Button
                      ...
                      className="absolute right-2 top-2 opacity-0 group-hover:opacity-100 transition-opacity"
                      onClick={() =>
                        copyToClipboard(responseExample, "responseAll")
                      }
                    >
                      {copiedItems["responseAll"] ? (
                        <Check className="h-4 w-4" />
                      ) : (
                        <Copy className="h-4 w-4" />
                      )}
                ...
                <div>
                  <p className="text-sm mb-1">
                    For "easyToSay" character mode:
                  </p>
                  <div className="relative group">
                    <pre className="line-numbers language-json rounded-md overflow-x-auto bg-muted/50 p-4">
                      <code className="language-json whitespace-nowrap">
                        {responseExampleEasyToSay}
                      </code>
                    </pre>
                    <Button
                      variant="ghost"
            ...
            <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-md">
              ...
              <p className="text-sm text-blue-700 dark:text-blue-400">
                This API is available for public use. Feel free to integrate it
                into your applications.
              </p>
              <p className="text-sm text-blue-700 dark:text-blue-400 mt-2">
                <strong>Live API:</strong>{" "}
                <code className="bg-blue-100 dark:bg-blue-800 px-1.5 py-0.5 rounded">
              ...
              <p className="text-sm text-blue-700 dark:text-blue-400 mt-1">
                ...
                <code className="bg-blue-100 dark:bg-blue-800 px-1.5 py-0.5 rounded">
                  http://localhost:4174/api/generate
                </code>{" "}
                (API server)
                <br />
                <code className="bg-blue-100 dark:bg-blue-800 px-1.5 py-0.5 rounded mt-1 inline-block">
                  http://localhost:4176
                </code>{" "}
                (Development server)
              </p>
